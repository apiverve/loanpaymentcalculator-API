...
```gradle
dependencies {
    implementation 'com.github.apiverve:loanpaymentcalculator-api:1.1.12'
}
```
...
```java
import com.apiverve.loanpaymentcalculator.LoanCalculatorAPIClient;
import com.apiverve.loanpaymentcalculator.APIResponse;
import com.apiverve.loanpaymentcalculator.APIException;

// Initialize the client
LoanCalculatorAPIClient client = new LoanCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/loanpaymentcalculator](https://docs.apiverve.com/ref/loanpaymentcalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/loanpaymentcalculator](https://docs.apiverve.com/ref/loanpaymentcalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/loanpaymentcalculator-api/issues)

...
class loanpaymentcalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/loanpaymentcalculator');
        }
        ...
        this.validationRules = {"loanAmount":{"type":"number","required":true,"min":0},"interestRate":{"type":"number","required":true,"min":0,"max":100},"loanTerm":{"type":"integer","required":true,"min":1,"max":50}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/loanpaymentcalculator`);
        }
    }
...
module.exports = loanpaymentcalculatorWrapper;

...
namespace APIVerve\Loanpaymentcalculator;
...
/**
 * Client for the Loan Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/loanpaymentcalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/loanpaymentcalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LoanpaymentcalculatorClient] {$message}\n";
        }
    }
}

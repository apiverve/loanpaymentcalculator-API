...
namespace APIVerve.API.LoanCalculator
{
    ...
    /// <summary>
    /// Client for the LoanCalculator API
    /// </summary>
    public class LoanCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/loanpaymentcalculator";
        ...
        {
            { "loanAmount", new ValidationRule { Type = "number", Required = true, Min = 0 } },
            { "interestRate", new ValidationRule { Type = "number", Required = true, Min = 0, Max = 100 } },
            { "loanTerm", new ValidationRule { Type = "integer", Required = true, Min = 1, Max = 50 } }
        };
        ...
        public LoanCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LoanCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public LoanCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, LoanCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(LoanCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(LoanCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(LoanCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(LoanCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(LoanCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(LoanCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(LoanCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(LoanCalculatorQueryOptions options)
        {
